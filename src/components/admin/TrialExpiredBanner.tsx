    ...
    <Card className="border-warning border-2 bg-warning/5">
      <CardContent className="flex flex-col items-center justify-center py-8 text-center">
        ...
        <p className="text-muted-foreground mb-4 max-w-sm">
          Manage your subscription at joinkoala-kraft-pro.lovable.app to continue using all features.
        </p>
        ...
        <p className="text-xs text-muted-foreground mt-4">
          Open joinkoala-kraft-pro.lovable.app/dashboard/subscription in your browser
        </p>
      </CardContent>
    </Card>
  );
