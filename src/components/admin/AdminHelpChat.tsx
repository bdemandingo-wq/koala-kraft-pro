        ...
        <div className="fixed bottom-24 md:bottom-6 right-6 z-50 flex w-[400px] max-w-[calc(100vw-2rem)] flex-col rounded-2xl border bg-background shadow-2xl" style={{ height: "min(600px, calc(100vh - 6rem))" }}>
          ...
          <div className="flex items-center gap-2 border-b px-4 py-3">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-sm font-semibold">{view === "history" ? "Chat History" : "Remain Clean Services Help"}</h3>
                ...
                {messages.length === 0 && (
                  <div className="flex flex-col items-center justify-center h-full text-center gap-3 py-8">
                    ...
                    <p className="text-sm text-muted-foreground max-w-[260px]">
                      Hi! I know everything about Remain Clean Services. Ask me anything or send a photo for me to analyze.
                    </p>
                  </div>
                )}
                {messages.map((msg, i) => (
