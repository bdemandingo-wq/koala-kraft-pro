...
export function PnLOverview({ bookings, customers }: PnLOverviewProps) {
  ...
  const saveSettings = async () => {
    ...
    const payload = {
      ...
      local_marketing_spend: (channelData['local_marketing_spend'] || settings.marketing_channels[3]?.monthly || Array(12).fill(0)) as unknown as Json,
      direct_mail_spend: (channelData['direct_mail_spend'] || settings.marketing_channels[4]?.monthly || Array(12).fill(0)) as unknown as Json,
      marketing_channel_names: channelNames as unknown as Json,
      ...
      recruiting_costs: settings.recruiting_costs as unknown as Json,
    };
