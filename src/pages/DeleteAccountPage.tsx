...
export default function DeleteAccountPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error("Something went wrong. Please email Support@remainclean.com directly.");
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <>
      <Seo
        title="Delete Your Remain Clean Services Account | Data Deletion Request"
        description="Request deletion of your Remain Clean Services account and all associated data. Required for Google Play Store data safety compliance."
        ...
        <header className="border-b bg-card">
          <div className="container max-w-3xl mx-auto px-4 py-6">
            <div className="flex items-center gap-3">
              <img src="/images/remainclean-logo.webp" alt="Remain Clean Services" className="h-8 w-auto" loading="lazy" />
              <span className="text-xl font-bold text-foreground">Remain Clean Services</span>
            </div>
          </div>
        </header>
        ...
        <main className="container max-w-3xl mx-auto px-4 py-10 space-y-8">
          ...
          <div className="space-y-3">
            <h1 className="text-3xl font-bold text-foreground flex items-center gap-3">
              ...
              Delete Your Remain Clean Services Account
            </h1>
            <p className="text-muted-foreground text-lg">
              You can request deletion of your Remain Clean Services account and all associated data.
