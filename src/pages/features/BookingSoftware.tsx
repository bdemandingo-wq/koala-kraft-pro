...
export default function BookingSoftware() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Seo 
        title="Online Booking Software for Car Detailing Businesses | Remain Clean Services"
        description="Let clients book detailing services online 24/7. Remain Clean Services automates your booking process so you never miss a job. Try free today."
        canonicalPath="/features/booking"
        ogImage="/images/remainclean-og.png"
        jsonLd={{
          "@type": "SoftwareApplication",
          "name": "Remain Clean Services Booking Software",
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Stop playing phone tag with clients. Remain Clean Services gives your car detailing business a professional online booking system that works around the clock — even while you're on the job.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-primary/5">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">Join hundreds of car detailing businesses using Remain Clean Services to fill their calendar. Start free, no credit card required.</p>
          <Button size="lg" className="text-lg px-8 h-14" onClick={handleStartFreeTrial}>
            Get Started Free <ArrowRight className="ml-2 h-5 w-5" />
          </Button>
        </div>
