      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-primary">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-primary-foreground/80 mb-8">
            Join thousands of cleaning businesses using automated dispatching. Start your free trial today.
          </p>
      ...
      <footer className="py-12 px-4 sm:px-6 lg:px-8 border-t border-border">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-6 mt-4">
            ...
            <a href="/features/quote-software" className="text-muted-foreground hover:text-foreground">Quote Software</a>
            <a href="/features/sms-notifications" className="text-muted-foreground hover:text-foreground">SMS Notifications</a>
          </div>
        </div>
      </footer>
