...
export default function StaffResetPasswordPage() {
  ...
  if (checkingSession) {
    return (
      <main className="min-h-screen flex items-center justify-center bg-background">
        <Seo title="Reset Staff Password | Remain Clean Services" description="Reset your staff portal password" canonicalPath={canonicalPath} />
  ...
  if (success) {
    return (
      <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-accent/5 p-4">
        <Seo title="Password Updated | Remain Clean Services" description="Your password was updated" canonicalPath={canonicalPath} />
  ...
  if (!isValidSession) {
    return (
      <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-accent/5 p-4">
        <Seo title="Reset Link Expired | Remain Clean Services" description="Password reset link expired" canonicalPath={canonicalPath} />
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-accent/5 p-4">
      <Seo title="Set Staff Password | Remain Clean Services" description="Create a new staff portal password" canonicalPath={canonicalPath} />
